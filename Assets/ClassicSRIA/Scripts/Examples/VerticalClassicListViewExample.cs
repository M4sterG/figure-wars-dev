...
namespace frame8.ScrollRectItemsAdapter.Classic.Examples
{
    ...
    public class VerticalClassicListViewExample : ClassicSRIA<SimpleExpandableClientViewsHolder>, CExpandCollapseOnClick.ISizeChangesHandler
    {
        ...
        private LayoutElement _PrefabLayoutElement;

        // Used to quickly retrieve the views holder given the gameobject
        private Dictionary<RectTransform, SimpleExpandableClientViewsHolder> _MapRootToViewsHolder = new Dictionary<RectTransform, SimpleExpandableClientViewsHolder>();
        ...
        protected override void UpdateViewsHolder(SimpleExpandableClientViewsHolder vh)
        {
            vh.UpdateViews(Data[vh.ItemIndex]);
        }

        #endregion ClassicSRIA implementation
        ...
        private void OnItemCountChangeRequested()
        { ChangeModelsAndReset(demoUI.SetCountValue); }
        ...
        #endregion events from DrawerCommandPanel
        ...
        #endregion CExpandCollapseOnClick.ISizeChangesHandler implementation
        ...
        private ExpandableSimpleClientModel CreateNewModel(int index)
        {
